...
public abstract class IdentityVerificationFragment extends BaseRecyclerFragment {
    ...
    protected void processFacePassResult(List<CBGFacePassRecognizeResult> faceTokenList) {
        ...
        if (faceTokenList != null && !faceTokenList.isEmpty()) {
            ...
            Log.d(TAG, "limefaceTokenList processFacePassResult faceTokenList.size(): " + faceTokenList.size());
            Log.d(TAG, "limefaceTokenList processFacePassResult faceTokenList.get(0).getFaceToken(): " + faceTokenList.get(0).getFaceToken());
    ...
    private void NormalListDialog(List<CBGFacePassRecognizeResult> faceTokenList,ArrayList<DialogMenuItem> mMenuItems) {
        Log.d(TAG, "limeFile NormalListDialog: " + 416);
       ...
       speakTTSVoice("请选择用户");
        ...
        listDialog.setOnOperItemClickL(new OnOperItemClickL() {
            ...
            public void onOperItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                processFacePassResultSingle(faceTokenList.get(position));
                listDialog.dismiss();
            }
        });
    }
