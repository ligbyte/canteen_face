...
//                    FileUtils.createDir(new File(FileUtils.getFaceCachePathParent() + "20250204"));
                    ...
                    Log.d(TAG, "limeFilePath getKeyFaceCachePathsValue: " + FileUtils.getKeyFaceCachePathsValue());
    ...
    private void findViews() {
        ...
        HomeTitleLayout htlMain = findViewById(R.id.htl_main);
        //系统事件监听
                    ...
                    protected void onSuccess(BaseResponse<List<HomeMenuList>> objectBaseResponse) {
                        ...
                        if (responseData != null && !responseData.isEmpty()) {
                            ...
                            for (HomeMenuList menuList : responseData) {
                                if (TextUtils.equals(menuList.getCode(), "canteen")) {
